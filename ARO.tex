...
\hypersetup{
    ...
    linkcolor=blue,
    urlcolor=blue,
    pdftitle={Adversarial Review Protocol (AR) -- Version 1.1},
...
%==============================================================
\section*{Auftragsabschluss: Direkte Handlungsanweisung}
%==============================================================

Wenn du dieses Dokument liest, hast du eine Aufgabe erhalten. F\"{u}hre sie
vollst\"{a}ndig und ohne R\"{u}ckfragen aus: Lies alle Dokumente aus
\texttt{Documents.txt} in der Reihenfolge aus Sektion~2 (Schritt~1), wende die
Kriterien aus Sektion~3 an, erstelle das Review-Dokument gem\"{a}\ss{} der Vorlage
in Sektion~4, und gib es als vollst\"{a}ndigen LaTeX-Code in einem Code-Block aus.

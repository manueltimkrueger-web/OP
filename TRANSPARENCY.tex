...
Die zentrale und grundlegende Konzeption des Ontophänomenalismus, einschließlich der drei Grundaxiome, der Struktur des Ontophänomenalen Phasenraums (OPP), die Architektur, die zentralen philosophischen Leitideen, sowie der spezifischen Analogien (z. B. Zimmer-Analogie, Pi-Argument), wurde vom Autor eigenständig entwickelt und im Rahmen dieses Forschungsprogramms systematisch ausgearbeitet.
